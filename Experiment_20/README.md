...
![Build Backend](./Screenshots/step3_build_backend.png)

**Building frontend image:**

![Build Frontend](./Screenshots/step3_build_frontend.png)

**Both images listed:**

![Docker Images](./Screenshots/step3_docker_images.png)
...
![Network and MySQL](./Screenshots/step4_network_mysql.png)

**Starting backend and frontend containers:**

![Run Containers](./Screenshots/step4_run_containers.png)

**All 3 containers running:**

![Docker PS](./Screenshots/step4_docker_ps.png)
...
*(Compose builds images, pulls MySQL, creates network, and starts all containers automatically)*

**All services started by Compose:**

*(All 3 services — db, backend, frontend — start in dependency order)*
...
**backend-test job passed** — runs pytest against a real MySQL service container.

**frontend-test job passed** — runs Vitest component tests.

**backend-docker job passed** — image built and pushed to Docker Hub.

**frontend-docker job passed** — image built and pushed to Docker Hub.

**deploy job passed** — smoke test on `/register` endpoint successful.
